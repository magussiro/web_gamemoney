        ...
        <?php if (!empty($_SESSION['fuser_account'])) { ?>
            ...
            <div id="userInfoDiv">
                ...
                <div>
                    ...
                    <?php endif; ?>
                    <?php
                    if ($viewData['member']['m_vip'] == 0) {
                        $member_vip = "一般會員";
                    }
                    if ($viewData['member']['m_vip'] == 1) {
                        $member_vip = "普卡會員";
                    }
                    if ($viewData['member']['m_vip'] == 2) {
                        $member_vip = "銀卡會員";
                    }
                    if ($viewData['member']['m_vip'] == 3) {
                        $member_vip = "金卡會員";
                    }
                    if ($viewData['member']['m_vip'] == 4) {
                        $member_vip = "白金卡會員";
                    }
                    ?>
                    <p><span class="userInfo_title">等　級：</span>LV.<?php echo $viewData['member']['m_vip']; ?><a href="">（<?php echo $member_vip; ?>）</a></p>
