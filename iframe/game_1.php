...
<div id="warp" style="background-color: black;height:100%;">
	...
	<iframe id="iframe1" name="iframe1" style="width:100%;height:100%;padding-top:35px;" src="<?php echo $webglroot; ?>index.html?user=<?php echo $_COOKIE['member_account']; ?>&key=<?php echo $frame_value ?>" scrolling="NO" allowfullscreen="true"></iframe>
</div>
