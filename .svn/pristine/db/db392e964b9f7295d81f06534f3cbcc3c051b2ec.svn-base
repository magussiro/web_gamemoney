...
$arr_input['name'] = ft($_GET['name'], 1);
//var_dump($arr_input);
$arr_page['page_id'] = ft($_GET['pageID'], 0);
$res_sum = get_deposits_count($admin_db, $arr_input);
//$res_sum = get_member($db, $arr_input);

//var_dump($res_sum);
$arr_page['num'] = $res_sum;
$page = new pager($arr_page);
$res = get_deposits($admin_db, $page, $arr_input);
//var_dump($res);
            ...
            <div class="span10">
                    ...
                    <div class="row-fluid">
                        <div class="pull-left span3 text-left">
                            <button class="btn btn-primary"
                                    onclick="dialog_set('deposit_add.php?act=add','手動儲值',600,450);">新增
                            </button>
                        </div>
                    </div>
                    <?php
                ...
                <div class="pull-right text-right">
                    <form class="form-search" method="get">
                        ...
                        <span>姓名 : <input name="name" id="name" class="input-medium search-query" placeholder="請輸入姓名"
                                          type="text"
