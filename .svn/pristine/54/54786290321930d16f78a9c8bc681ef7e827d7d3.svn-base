...
<div id="warp2" style="background-color: black;height:100%;">
  ...
  <iframe id="iframe2" name="iframe2" style="width:100%;height:100%;padding-top:35px;" src="<?php echo $webglroot; ?>index2.html?user=<?php echo $_COOKIE['member_account']; ?>&key=<?php echo $frame_value ?>" scrolling="NO"></iframe>
</div>
