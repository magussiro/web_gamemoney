...
if ($id != '') {
    $category = get_news_id($admin_db, $id);
    // var_dump($category);
    $category_one = get_one_news_id($admin_db, $id);
...
<html>
    ...
    <body>
        ...
        <form class="form-horizontal" action="latest_news_add_mod_act.php" method="post" enctype="multipart/form-data">
                ...
                <div class="controls">
                    <select name="cg_id" id="cg_id">
                        ...
                        foreach ($aa as $cl_key => $cl_row) {
                            ?>
                            <option value="<?php echo $cl_row['name']; ?>" <?php echo ($category_one['news_type'] == $cl_row['id']) ? 'selected="selected"' : '' ?>> <?php echo $cl_row['name']; ?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input type="text" placeholder="請輸入文章類別" value="<?php echo $category_one['title']; ?>" name="at_title"
            ...
            <div class="control-group">
                ...
                <label class="control-label" for="input01">公告內容<span class="red">*</span>：</label>
                <div class="controls">

                    <input type="text" placeholder="請輸入公告內容" value="<?php echo $category_one['content']; ?>" name="at_content"
                           id="at_title" class="input-xlarge">
