...
$res = get_Problem_Management($admin_db, $arr_input, $page, $mod, $res);
//var_dump($res);
?>
<!--畫面呈現-->
        ...
        <div class="span10">
            ...
            <div class="row-fluid">
                <div class="pull-left span10 text-left">
                    <div class="btn-group">
                        <a href="common_problem.php?mod=0"  class="btn"  title="全部"><b>全部</b></a>
                        <a href="common_problem.php?mod=1&name<?php echo $name; ?>"  class="btn"  title="遊戲問題"><b>遊戲問題</b></a>
                        <a href="common_problem.php?mod=2&name=<?php echo $name; ?>"  class="btn"  title="點數問題"><b>點數問題</b></a>
                        <a href="common_problem.php?mod=3&name=<?php echo $name; ?>"  class="btn"  title="點數問題"><b>其他問題</b></a>
            ...
            <div class="row-fluid">
                <div class="pull-left span3 text-left">
                    <button class="btn btn-primary" onclick="dialog_set('common_problem_add_mod.php?act=add', '新增', 600, 450);">新增</button>
                </div>
                    ...
                    <tbody>
                        ...
                        if (count($res) > 0) {
                            foreach ($res as $key => $row) {
                                ...
                                <tr>
                                    <td>
                                        <a class="alphm_obj" title="編輯" onmouseover="$(this).tooltip('show');" href="javascript:void(0);" onclick="dialog_set('common_problem_add_mod.php?id=<?php echo $row['id']; ?>', '修改', 600, 450);"><i class="icon-edit"></i></a>
                                    </td>
                                    <td>
                                        <?php
