...
<html>
    ...
    <body>
        <!--標題列-->
        <h3>
            <?php echo (count($id) > 0) ? '修改' : '新增'; ?>字串過濾管理
        </h3>
        <form class="form-horizontal" action="string_manger_add_mod_act.php" method="post" onSubmit="return checkForm();">
            <!--管別名稱-->
            <div class="control-group">
                <label class="control-label" for="input01">要被過濾的字串<span class="red">*</span>：</label>
                <div class="controls">
                    <input type="text" placeholder="請輸入要被過濾的字串" value="<?php echo $center_once['title']; ?>" name="title" id="ItemDesc"
                           class="input-xlarge">
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="input01">替換文字<span class="red">*</span>：</label>
                <div class="controls">
                    <input type="text" placeholder="請輸入替換文字" value="<?php echo $center_once['msg']; ?>" name="msg" id="OrderComment"
                           class="input-xlarge">
                </div>
            </div>
<!--            <div class="control-group">
