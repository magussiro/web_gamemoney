...
$add_sprint['one_bet'] = $_POST['one_bet'];
$add_sprint['start_score_max'] = $_POST['start_score_max'];
$add_sprint['start_score_one_score'] = $_POST['start_score_one_score'];
$add_sprint['min_up_score_value'] = $_POST['min_up_score_value'];
$add_sprint['max_down_score_value'] = $_POST['max_down_score_value'];
$add_sprint['down_score_one_score'] = $_POST['down_score_one_score'];
$add_sprint['down_score_add_score'] = $_POST['down_score_add_score'];
//$add_sprint['flush7'] = $_POST['flush7'];
//var_dump($_POST);
//die;
//七朵花
...
switch ($act) {
    ...
    case 'add':
        ...
        if ($add_id) {
            ...
            reload_js_top_href('更新成功!', 'slot_machine.php?game=ps_zone_list');
            //  die;
        } else {
            reload_js_top_href('更新失敗或沒有更新!', 'slot_machine.php?game=ps_zone_list');
        }
        break;
    //更新
    case 'mod':
