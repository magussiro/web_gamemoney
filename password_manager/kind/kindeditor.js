...
KE.lang = {
	...
	tablerowdelete : '刪除行',
	noColor : '無顏色',
	invalidImg : "請輸入有效的URL網址。\n只允許jpg,gif,png格式。",
	invalidMedia : "請輸入有效的URL網址。\n只允許swf,flv,mp3,wav,wma,wmv,mid,avi,mpg,asf,rm,rmvb格式。",
	invalidWidth : "寬度必須是數字。",
	invalidHeight : "高度必須是數字。",
	invalidBorder : "邊框必須是數字。",
	invalidUrl : "請輸入有效的URL網址。",
	invalidRows : '行數為必須選項，只允許輸入大於0的數字。',
	invalidCols : '列數為必須選項，只允許輸入大於0的數字。',
	invalidPadding : '編劇必須是數字。',
	invalidSpacing : '間距必須是數字。',
	invalidBorder : '邊框必須是數字。',
	pleaseInput : "請輸入內容。",
	invalidJson : '伺服器發生故障。',
	cutError : '您的瀏覽器安全設定不允許使用剪下操作，請使用快速鍵(Ctrl+X)來完成。',
	copyError : '您的瀏覽器安全設定不允許使用複製操作，請使用快速鍵(Ctrl+C)來完成。',
	pasteError : '您的瀏覽起安全設定不允許使用貼上操作，請使用快速鍵(Ctrl+V)來完成。'
};
...
plugins.plainpaste = {
	comment : '請使用快速鍵(Ctrl+V)把內容貼上到下面的方框中。'
};
...
KE.plugin['upimg'] = {
	click : function(id) 
	{
		window.open('../box_article/control.php?routing=kind','圖片上傳', config='height=376,width=450,scrollbars=no')
	}
};
