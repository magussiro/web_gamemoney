...
class func_index extends basePage
{
    ...
    public function page_load()
    {
        ...
        $viewData['topDeposit'] = $this->getRanksTopDeposit();
        $viewData['jpotData'] = $this->getJoptData();


    }

    public function getJoptData()
    {
    ...
    public function getRanksTopDeposit()
    {
        /**
         * 取得百大富豪排行:儲值
         *
