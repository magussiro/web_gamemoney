...
$res_sum = get_slotlog_select($db, $arr_input, $page, $id);
$arr_page['num'] = $res_sum['0']['cnt'];
$page = new pager($arr_page);

$res = get_slotlog_select($db, $arr_input, $page, $id, $ml_id, $start_date, $end_date);
...
<!--畫面呈現-->
            ...
            <div class="span10">
                ...
                <div class="row-fluid" id="search" style="<?php echo $search_display ?>" >
                  <div class="pull-right text-right">
                    <form class="member_slotlog" method="get"> 
                    ...
                    <table class="table table-hover table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                        <?php echo $row['ml_account']."(".$row['gml_id'].")";?>
                                </td>
                                <td>
                                        <?php echo $row['sm_id'];?>
                                </td>
    ...
    $(document).ready(function(){
  	     ...
  	     $('#btn').click(function(){
            ...
            window.location.href='member_slotlog_excel.php?mbid='+mbid+'&start_day='+start_day+'&end_day='+end_day;
