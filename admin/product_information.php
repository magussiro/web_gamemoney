            ...
            <div class="row-fluid">
                <div class="pull-left span3 text-left">
                    <button class="btn btn-primary"
                            onclick="dialog_set('product_information_add_mod.php?act=add', '新增', 600, 600);">新增
                    </button>
                </div>
            </div>
            <!--資料內容-->
                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th width="150">商品金額</th>
                            <th width="150">平台幣價值</th>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a class="alphm_obj" title="編輯" onmouseover="$(this).tooltip('show');"
                                           ...
                                           onclick="dialog_set('product_information_add_mod.php?id=<?php echo $row['id']; ?>', '修改', 600, 600);"><i
                                                class="icon-edit"></i></a>
                                    </td>
                                    <!--將資料表內容引入-->
                                    <td>
...
<script Language="JavaScript">
    ...
    function article_del(id, deleted) {
        ...
        if (confirm('您確定要' + str)) {
            window.location.href = 'product_information_add_mod_act.php?act=switch&id=' + id + '&deleted=' + deleted;
        }
    }
</script>
